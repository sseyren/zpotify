...
class MP3File
{
    ...
    public static function formatTime($duration) //as hh:mm:ss
    {
        ...
        if ( $hours == 0 ){
            return sprintf("%1d:%1d", $minutes, $seconds);
        }else{
            return sprintf("%1d:%1d:%1d", $hours, $minutes, $seconds);
        }
    }
...
/*
$mp3file = new MP3File("./icerik/46a87fde52.mp3");//http://www.npr.org/rss/podcast.php?id=510282
